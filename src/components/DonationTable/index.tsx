              ...
              {currentDonation && currentDonation.cupom ? currentDonation.cupom.map((cupom) => {
                ...
                return (
                  <StyledTableRow key={cupom.nome}>
                    ...
                    <StyledTableCell align="right">{validade.toLocaleDateString("pt-BR")}</StyledTableCell>
                    <StyledTableCell align="right">{isBefore(Date.now(),validade) ? "Ativo" : "Vencido"}</StyledTableCell>
                  </StyledTableRow>
                )
              })
