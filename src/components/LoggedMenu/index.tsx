  ...
  return (
    <LeftBox>
        ...
        <ul>
            ...
            <li><Link to="/donations" ><HiHeart size={32}/> Doações Realizadas</Link></li>
            <li><Link to="/cupons"><HiGift size={32}/> Cupons</Link></li>
            <li><Link to="/institutions"><HiHome size={32}/> Instituições Amparadas</Link></li>
